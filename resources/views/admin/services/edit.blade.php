    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.services.update", [$service->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('services_image') ? 'is-invalid' : '' }}" type="text" name="services_image" id="services_image" value="{{ old('services_image', $service->services_image) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('services_title') ? 'is-invalid' : '' }}" type="text" name="services_title" id="services_title" value="{{ old('services_title', $service->services_title) }}">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('services_text') ? 'is-invalid' : '' }}" name="services_text" id="services_text">{!! old('services_text', $service->services_text) !!}</textarea>
