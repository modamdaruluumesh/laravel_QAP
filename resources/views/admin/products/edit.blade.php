            ...
            <form method="POST" action="{{ route('admin.products.update', [$product->id]) }}" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control ckeditor {{ $errors->has('product_description') ? 'is-invalid' : '' }}"
                        name="product_description" id="product_description">{!! old('product_description', $product->product_description) !!}</textarea>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('product_breif_info') ? 'is-invalid' : '' }}" type="text"
                        name="product_breif_info" id="product_breif_info"
                        value="{{ old('product_breif_info', $product->product_breif_info) }}">
