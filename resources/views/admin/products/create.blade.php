            ...
            <form method="POST" action="{{ route('admin.products.store') }}" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('product_image') ? 'is-invalid' : '' }}" type="file"
                        name="product_image" id="product_image" value="{{ old('product_image', '') }}">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('product_code') ? 'is-invalid' : '' }}" type="text"
                        name="product_code" id="product_code" value="{{ old('product_code', '') }}">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('product_price') ? 'is-invalid' : '' }}" type="text"
                        name="product_price" id="product_price" value="{{ old('product_price', '') }}">
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control ckeditor {{ $errors->has('product_description') ? 'is-invalid' : '' }}"
                        name="product_description" id="product_description">{!! old('product_description') !!}</textarea>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('product_breif_info') ? 'is-invalid' : '' }}" type="text"
                        name="product_breif_info" id="product_breif_info" value="{{ old('product_breif_info', '') }}">
