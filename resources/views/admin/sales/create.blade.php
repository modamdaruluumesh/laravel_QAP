    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.sales.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('catergory_name') ? 'is-invalid' : '' }}" name="catergory_name_id" id="catergory_name_id">
                    @foreach($catergory_names as $id => $entry)
                        <option value="{{ $id }}" {{ old('catergory_name_id') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('sub_total') ? 'is-invalid' : '' }}" type="text" name="sub_total" id="sub_total" value="{{ old('sub_total', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('total_payable') ? 'is-invalid' : '' }}" type="text" name="total_payable" id="total_payable" value="{{ old('total_payable', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('amount_payable') ? 'is-invalid' : '' }}" type="text" name="amount_payable" id="amount_payable" value="{{ old('amount_payable', '') }}">
