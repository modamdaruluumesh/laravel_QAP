...
class ServicesController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if ($request->ajax()) {
            ...
            $table->editColumn('services_image', function ($row) {
                return $row->services_image ? $row->services_image : '';
            });
            $table->editColumn('services_title', function ($row) {
                return $row->services_title ? $row->services_title : '';
            });
