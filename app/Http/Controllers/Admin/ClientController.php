...
class ClientController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if ($request->ajax()) {
            ...
            $table->editColumn('client_email', function ($row) {
                return $row->client_email ? $row->client_email : '';
            });
            $table->editColumn('client_phone_number', function ($row) {
                return $row->client_phone_number ? $row->client_phone_number : '';
            });
